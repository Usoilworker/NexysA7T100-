...
HD_PWD='C:/Users/Jason/Step2V1.3/Step2V1.3.runs/TOP_SWITCH_IO_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_SWITCH_IO_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_SWITCH_IO_0_0.tcl
