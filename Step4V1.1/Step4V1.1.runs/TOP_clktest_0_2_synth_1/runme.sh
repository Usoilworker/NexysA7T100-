...
HD_PWD='C:/Users/Jason/Step4V1.1/Step4V1.1.runs/TOP_clktest_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_clktest_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_clktest_0_2.tcl
