...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins clktest_0/i_clk]
  connect_bd_net -net clktest_0_o_ledg [get_bd_pins LED_IO_0/INTLED00] [get_bd_pins clktest_0/o_ledg]
