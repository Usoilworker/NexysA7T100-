...
HD_PWD='C:/Users/Jason/Step4V1/Step4V1.runs/design_1_SWITCH_IO_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_SWITCH_IO_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_SWITCH_IO_0_0.tcl
