...
# module references:
# Button_IO, CustomClock, LED_IO, SWITCH_IO
...
proc create_root_design { parentCell } {
  ...
  set PHYB1_0 [ create_bd_port -dir I PHYB1_0 ]
  ...
  # Create instance: Button_IO_0, and set properties
  set block_name Button_IO
  set block_cell_name Button_IO_0
  if { [catch {set Button_IO_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $Button_IO_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: CustomClock_0, and set properties
  set block_name CustomClock
  set block_cell_name CustomClock_0
  if { [catch {set CustomClock_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $CustomClock_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net Button_IO_0_INTB1 [get_bd_pins Button_IO_0/INTB1] [get_bd_pins CustomClock_0/CC_Step]
  connect_bd_net -net CustomClock_0_CC_OUT [get_bd_pins CustomClock_0/CC_OUT] [get_bd_pins LED_IO_0/INTLED00]
  ...
  connect_bd_net -net PHYB1_0_1 [get_bd_ports PHYB1_0] [get_bd_pins Button_IO_0/PHYB1]
  ...
  connect_bd_net -net SWITCH_IO_0_INTSW0e [get_bd_pins CustomClock_0/CC_HS_LS] [get_bd_pins LED_IO_0/INTLED0e] [get_bd_pins SWITCH_IO_0/INTSW0e]
  connect_bd_net -net SWITCH_IO_0_INTSW0f [get_bd_pins CustomClock_0/FR_SS] [get_bd_pins LED_IO_0/INTLED0f] [get_bd_pins SWITCH_IO_0/INTSW0f]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins CustomClock_0/CC_IN_5mhz] [get_bd_pins clk_wiz_0/clk_out1]
